...
enum {E_BUILTIN10X16,E_BUILTIN5X8,E_FREEMONO9,MAX_FONT};
//<Enum !End!>
...
//<InitGUI !Start!>
  ...
  pElemRef = gslc_ElemCreateTxt(&m_gui,CAPACITY_NUM_MONITOR,E_PG_MAIN,(gslc_tsRect){32,70,59,18},
    (char*)m_sInputNumber2,5,E_BUILTIN10X16);
