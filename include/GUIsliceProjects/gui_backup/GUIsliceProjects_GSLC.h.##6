...
enum {CAPACITY_NUM_MONITOR,E_DRAW_LINE1,E_ELEM_TEXT1,OCCUPANCY_GAGE
      ,E_ELEM_KEYPAD_NUM};
// Must use separate enum for fonts with MAX_FONT at end to use gslc_FontSet.
enum {E_BUILTIN5X8,E_FREEMONO12,E_FREEMONO9,MAX_FONT};
//<Enum !End!>
...
//<InitGUI !Start!>
  ...
  static char m_sInputNumber2[5] = "";
  pElemRef = gslc_ElemCreateTxt(&m_gui,CAPACITY_NUM_MONITOR,E_PG_MAIN,(gslc_tsRect){30,74,64,17},
    (char*)m_sInputNumber2,5,E_FREEMONO12);
  ...
  pElemRef = gslc_ElemCreateLine(&m_gui,E_DRAW_LINE1,E_PG_MAIN,37,99,87,99);
  gslc_ElemSetCol(&m_gui,pElemRef,GSLC_COL_BLACK,GSLC_COL_GRAY_LT2,GSLC_COL_GRAY_LT2);
  
  // Create E_ELEM_TEXT1 text label
  pElemRef = gslc_ElemCreateTxt(&m_gui,E_ELEM_TEXT1,E_PG_MAIN,(gslc_tsRect){40,10,43,12},
    (char*)"BEDS",0,E_FREEMONO9);
  gslc_ElemSetTxtAlign(&m_gui,pElemRef,GSLC_ALIGN_MID_MID);
