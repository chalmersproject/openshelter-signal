...
// ------------------------------------------------
//<Enum !Start!>
enum {E_PG_MAIN,E_PG_WIFI_CONNECT,E_POP_KEYPAD_NUM};
enum {CAPACITY_NUM_MONITOR,E_DRAW_LINE1,E_ELEM_IMAGE4,E_ELEM_NUMINPUT3
      ,E_ELEM_TEXT1,E_ELEM_TEXT2,OCCUPANCY_GAGE,E_ELEM_KEYPAD_NUM};
// Must use separate enum for fonts with MAX_FONT at end to use gslc_FontSet.
enum {E_BUILTIN5X8,E_FREESANS18,E_FREESANS9,E_FREESANSBOLD9,MAX_FONT};
//<Enum !End!>
...
#define MAX_ELEM_PG_WIFI_CONNECT 2 // # Elems total on page
#define MAX_ELEM_PG_WIFI_CONNECT_RAM MAX_ELEM_PG_WIFI_CONNECT // # Elems in RAM
//<ElementDefines !End!>
...
gslc_tsElem                     m_asPage2Elem[MAX_ELEM_PG_WIFI_CONNECT_RAM];
gslc_tsElemRef                  m_asPage2ElemRef[MAX_ELEM_PG_WIFI_CONNECT];
...
//<InitGUI !Start!>
  ...
  gslc_PageAdd(&m_gui,E_PG_WIFI_CONNECT,m_asPage2Elem,MAX_ELEM_PG_WIFI_CONNECT_RAM,m_asPage2ElemRef,MAX_ELEM_PG_WIFI_CONNECT);
  ...
  pElemRef = gslc_ElemCreateTxt(&m_gui,E_ELEM_TEXT1,E_PG_MAIN,(gslc_tsRect){37,5,50,15},
    (char*)"BEDS",0,E_FREESANSBOLD9);
  gslc_ElemSetTxtAlign(&m_gui,pElemRef,GSLC_ALIGN_MID_MID);
  ...
  // -----------------------------------
  // PAGE: E_PG_WIFI_CONNECT
  
 
  // Create E_ELEM_IMAGE4 using Image 
  pElemRef = gslc_ElemCreateImg(&m_gui,E_ELEM_IMAGE4,E_PG_WIFI_CONNECT,(gslc_tsRect){31,40,62,63},
    gslc_GetImageFromFile(IMG_G999,GSLC_IMGREF_FMT_JPG));
  
  // Create E_ELEM_TEXT2 text label
  pElemRef = gslc_ElemCreateTxt(&m_gui,E_ELEM_TEXT2,E_PG_WIFI_CONNECT,(gslc_tsRect){40,10,39,15},
    (char*)"WIFI",0,E_FREESANSBOLD9);
  gslc_ElemSetTxtAlign(&m_gui,pElemRef,GSLC_ALIGN_MID_MID);
  gslc_ElemSetTxtCol(&m_gui,pElemRef,GSLC_COL_WHITE);
