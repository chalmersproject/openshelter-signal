...
// ------------------------------------------------
//<Enum !Start!>
enum {E_PG_MAIN,E_PG_WIFICON,E_PG_CLOUDSYNC,E_PG_SUPPORTCALL
      ,E_POP_KEYPAD_NUM};
enum {CAPACITY_NUM_MONITOR,E_DRAW_LINE1,E_DRAW_LINE2,E_ELEM_BOX1
      ,E_ELEM_BOX2,E_ELEM_NUMINPUT3,E_ELEM_NUMINPUT5,E_ELEM_TEXT1
      ,E_ELEM_TEXT10,E_ELEM_TEXT11,E_ELEM_TEXT12,E_ELEM_TEXT13
      ,E_ELEM_TEXT14,E_ELEM_TEXT4,E_ELEM_TEXT5,E_ELEM_TEXT6
      ,E_ELEM_TEXT7,E_ELEM_TEXT8,E_ELEM_TEXT9,OCCUPANCY_GAGE
      ,E_ELEM_KEYPAD_NUM};
